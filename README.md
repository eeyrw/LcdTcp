...
If you download the bin from release page, you can upload binary through esptool. The following steps should be taken for using esptoo
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkwMzk2OTAwNF19
-->