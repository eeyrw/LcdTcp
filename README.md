...
**Upload firmware**
If you use Arduino IDE, the correct COM port should be set. Then click upload button. You can upload binary through esptool in the scenario that you just want to upload bin to ESP8266 with the bin from release page. The following steps can be taken:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU0MDg0MTAxOV19
-->