...
If you download the bin from release page, you can upload binary through esptool. The following steps should be taken for
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgwMzI2NTUzMl19
-->